cc.Class({
    ...
    onLoad(){
        //Arrow Button
        this.ArrowButton[0].node.on('mousedown', ()=>{
        ...
        this.ArrowButton[1].node.on('mousedown', ()=>{
            if(this._Effect === true)
                cc.audioEngine.playEffect(this.Click, false);
    ...
    start () {
        ...
        this.PlayButton.node.active = false;
        //Page 1
        this.NodeButton[0].on('mousedown', ()=>{
            if(this._Effect === true)
                cc.audioEngine.playEffect(this.Click, false);
            ...
            if(this.PressCount === 1){
                this.NewGameBT[0].node.opacity = 100;
                this.NewGameBT[1].node.opacity = 210;
                this.ContinueBT[0].node.opacity = 0;
                this.ContinueBT[1].node.opacity = 0;
                this.Tutorial[0].node.opacity = 0;
                this.Tutorial[1].node.opacity = 0;
                this.PressCount++;
            }
        });
        this.NodeButton[1].on('mousedown', ()=>{
            if(this._Effect === true)
                cc.audioEngine.playEffect(this.Click, false);
            ...
            if(this.PressCount === 1){
                this.ContinueBT[0].node.opacity = 100;
                this.ContinueBT[1].node.opacity = 210;
                this.NewGameBT[0].node.opacity = 0;
                this.NewGameBT[1].node.opacity = 0;
                this.Tutorial[0].node.opacity = 0;
                this.Tutorial[1].node.opacity = 0;
                this.PressCount++;
            }
        });
        this.NodeButton[2].on('mousedown', ()=>{
            if(this._Effect === true)
                cc.audioEngine.playEffect(this.Click, false);
            ...
            if(this.PressCount === 1){
                this.Tutorial[0].node.opacity = 100;
                this.Tutorial[1].node.opacity = 210;
                this.NewGameBT[0].node.opacity = 0;
                this.NewGameBT[1].node.opacity = 0;
                this.ContinueBT[0].node.opacity = 0;
                this.ContinueBT[1].node.opacity = 0;
        ...
        //Page 2
        this.NodeButton[3].on('mousedown', ()=>{
            if(this._Effect === true)
                cc.audioEngine.playEffect(this.Click, false);
            ...
            if(this.PressCount === 1){
                this.EasyMode[0].node.opacity = 100;
                this.EasyMode[1].node.opacity = 210;
                this.NormalMode[0].node.opacity = 0;
                this.NormalMode[1].node.opacity = 0;
                this.HardMode[0].node.opacity = 0;
                this.HardMode[1].node.opacity = 0;
                this.PressCount++;
            }
        });
        this.NodeButton[4].on('mousedown', ()=>{
            if(this._Effect === true)
                cc.audioEngine.playEffect(this.Click, false);
            ...
            if(this.PressCount === 1){
                this.NormalMode[0].node.opacity = 100;
                this.NormalMode[1].node.opacity = 210;
                this.EasyMode[0].node.opacity = 0;
                this.EasyMode[1].node.opacity = 0;
                this.HardMode[0].node.opacity = 0;
                this.HardMode[1].node.opacity = 0;
                this.PressCount++;
            }
        });
        this.NodeButton[5].on('mousedown', ()=>{
            if(this._Effect === true)
                cc.audioEngine.playEffect(this.Click, false);
            ...
            if(this.PressCount === 1){
                this.HardMode[0].node.opacity = 100;
                this.HardMode[1].node.opacity = 210;
                this.EasyMode[0].node.opacity = 0;
                this.EasyMode[1].node.opacity = 0;
                this.NormalMode[0].node.opacity = 0;
                this.NormalMode[1].node.opacity = 0;
